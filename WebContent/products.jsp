...
<body>
	<div id="page-wrapper">
		...
		<br>
		<div class="row">
			<span class="col-sm-4" style="font-size:20px;"><b>&nbsp;ALL</b></span>
		</div>	
			<hr>
		...
		<div class="contain">
			<div class="row" align="center">
				...
				<%
						...
						if(discount==0){ 
				%>
					<div id="btn" style="width:250px; float:left; margin: 22px;" class="btn btn-light" onclick="location.href='./product.jsp?id=<%=rs.getString("p_id")%>';">
				...
				%>
					...
					<p id="name1" style="color: #D4D5DD">
						...
						%>
						<STRIKE style="color:red;"><%=rs.getString("p_fixedPrice")%>원</STRIKE> <span id="name1"
