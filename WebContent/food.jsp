...
<body>
	<div id="page-wrapper">
		...
		<% 
			String sql2 = "select count(*) from product where p_id like 'P%'";
			int rowcount=0;
		...
		<br>
		<div class="row">
			<span class="col-sm-4"style="font-size:20px;"><b>&nbsp;FOOD</b></span>
		</div>	
			<hr>
		...
		<div class="contain">
			<div class="row" align="center">
				<%
					String sql = "select * from product where p_id like 'P%'";
